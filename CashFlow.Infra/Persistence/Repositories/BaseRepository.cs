...
namespace CashFlow.Infra.Persistence.Repositories
{
    public class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class
    {
        ...
        public virtual async Task<IQueryable<TEntity>> GetAll(bool asNoTracking = true)
        {
            if (asNoTracking)
        ...
        public virtual async Task<IQueryable<TEntity>> GetAllIncluding(params Expression<Func<TEntity, object>>[] includeProperties)
        {
            IQueryable<TEntity> queryable = await GetAll();
